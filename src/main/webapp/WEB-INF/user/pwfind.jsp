...
<style>
  ...
  #pwfind-form{  position: relative; transform: translate(560px, 0px); border-radius: 5px; padding: 5px; background-color: #FFFFF4; width: 228px; padding: 10px; border: 1px solid  #ABDEC2;}
